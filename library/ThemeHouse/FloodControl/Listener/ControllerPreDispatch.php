...
class ThemeHouse_FloodControl_Listener_ControllerPreDispatch extends ThemeHouse_Listener_ControllerPreDispatch
{
    ...
    {
        $controllerPreDispatch = new ThemeHouse_FloodControl_Listener_ControllerPreDispatch($controller, $action);
